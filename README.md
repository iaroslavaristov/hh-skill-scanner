...
Мощная CLI-утилита на **Go**, которая анализирует вакансии с HeadHunter и с помощью нейросети **Gemini 3.0 Flash** извлекает из них актуальный список требуемых IT-технологий и навыков.



## Особенности

* **AI-Анализ**: Использует возможности **Gemini 3.0 Flash** для глубокого понимания текста вакансий.
